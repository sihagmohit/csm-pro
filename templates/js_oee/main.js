...
function chartOeeTrendInit(title, series) {
    ...
    if (series == null) {
        ...
        var Quality = [];
        var n = 100;
        var tm = Math.round(new Date().getTime() / 1000) * 1000 - n * 13450;
        for (var i = 0; i < n; i++) {
            tm += 13450;
           ...
           // height: 400,
            ...
            events: {
                load: function () {
                    ...
                    ren.image('img/iconPC.png', 715, 40, 90, 80).add();
                    ren.image('img/iconPC.png', 715, 275, 90, 80).add();
                    ren.image('img/iconScanner.png', 212, 180, 36, 36).add();
                    ren.image('img/iconScanner.png', 632, 180, 36, 36).add();
                    ren.image('img/iconScanner.png', 857, 80, 36, 36).add();
                    ren.image('img/iconScanner.png', 857, 280, 36, 36).add();
...
function sblIdlingAndMinorStops(newRate, occurrences, totalizer) {
    rtsOEEM.sblIdlingAndMinorStops.rate.shift();
    alert(rtsOEEM.sblIdlingAndMinorStops.rate);
...
var a1=[10,11,12,13,14,15,16,10,10];
var a2=[10,11,12,13,14,15,16,10,10];
var a3=[10,11,12,13,14,15,16,10,10];
var a4=[10,11,12,13,14,15,16,10,10];
var a5=[10,11,12,13,14,15,16,10,10];
var a6=[10,11,12,13,14,15,16,10,10];
...
var time5 = setInterval(sblChartsInit, 1000);
